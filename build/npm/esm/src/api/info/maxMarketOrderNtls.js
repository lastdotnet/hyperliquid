...
export const MaxMarketOrderNtlsResponse = /* @__PURE__ */ (() => {
    ...
    v.pipe(v.tuple([UnsignedDecimal, v.string()]), v.description("Tuple of maximum market order notional and corresponding asset symbol."))), v.description("Maximum market order notionals."));
})();
/**
 * Request maximum market order notionals.
