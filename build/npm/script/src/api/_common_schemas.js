...
exports.TwapFillSchema = exports.FillSchema = exports.TwapStatusSchema = exports.TwapStateSchema = exports.L2BookLevelSchema = exports.OrderProcessingStatusSchema = exports.DetailedOrderSchema = exports.OrderSchema = exports.CandleIntervalSchema = exports.PlaceOrderParamsSchema = exports.TIFSchema = void 0;
...
exports.PlaceOrderParamsSchema = (() => {
    return v.pipe(v.object({
        ...
        /** Client Order ID. */
        c: v.pipe(v.optional(v.pipe(_base_js_1.Hex, v.length(34))), v.description("Client Order ID.")),
    }), v.description("Place order parameters."));
})();
/** Candle interval. */
exports.CandleIntervalSchema = (() => {
    return v.pipe(v.union([
        v.literal("1m"),
        v.literal("3m"),
        v.literal("5m"),
...
exports.DetailedOrderSchema = (() => {
    return v.pipe(v.object({
        ...
        v.array(v.lazy(() => exports.DetailedOrderSchema)), v.description("Child orders associated with this order.")),
         ...
         * - `"LiquidationMarket"`: Similar to Ioc, used in Hyperliquid UI.
         */
        tif: v.nullable(exports.TIFSchema),
        /** Client Order ID. */
        cloid: v.pipe(v.nullable(v.pipe(_base_js_1.Hex, v.length(34))), v.description("Client Order ID.")),
...
exports.L2BookLevelSchema = (() => {
    return v.pipe(v.object({
        ...
        n: v.pipe(_base_js_1.UnsignedInteger, v.description("Number of individual orders.")),
...
exports.TwapStateSchema = (() => {
    return v.pipe(v.object({
        ...
        /** Duration in minutes. */
        minutes: v.pipe(_base_js_1.UnsignedInteger, v.description("Duration in minutes.")),
        ...
        timestamp: v.pipe(_base_js_1.UnsignedInteger, v.description("Start time of the TWAP order (in ms since epoch).")),
        /** User address. */
...
exports.FillSchema = (() => {
    return v.pipe(v.object({
        ...
        time: v.pipe(_base_js_1.UnsignedInteger, v.description("Timestamp when the trade occurred (in ms since epoch).")),
        /** Start position size. */
        startPosition: v.pipe(_base_js_1.Decimal, v.description("Start position size.")),
        /** Direction indicator for frontend display. */
        dir: v.pipe(v.string(), v.description("Direction indicator for frontend display.")),
        /** Realized PnL. */
        closedPnl: v.pipe(_base_js_1.Decimal, v.description("Realized PnL.")),
        /** L1 transaction hash. */
        ...
        fee: v.pipe(_base_js_1.Decimal, v.description("Fee charged or rebate received (negative indicates rebate).")),
        /** Unique transaction identifier for a partial fill of an order. */
        tid: v.pipe(_base_js_1.UnsignedInteger, v.description("Unique transaction identifier for a partial fill of an order.")),
        /** Client Order ID. */
        cloid: v.pipe(v.optional(v.pipe(_base_js_1.Hex, v.length(34))), v.description("Client Order ID.")),
        /** Liquidation details. */
        liquidation: v.pipe(v.optional(v.object({
            /** Address of the liquidated user. */
            liquidatedUser: v.pipe(_base_js_1.Address, v.description("Address of the liquidated user.")),
        ...
        /** ID of the TWAP. */
        twapId: v.pipe(v.nullable(_base_js_1.UnsignedInteger), v.description("ID of the TWAP.")),
    }), v.description("Order fill record."));
})();
/** TWAP fill record. */
exports.TwapFillSchema = (() => {
    return v.pipe(v.object({
        /** Asset symbol. */
        coin: v.pipe(v.string(), v.description("Asset symbol.")),
        /** Price. */
