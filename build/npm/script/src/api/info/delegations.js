...
exports.DelegationsResponse = (() => {
    ...
    v.pipe(v.object({
        ...
        lockedUntilTimestamp: v.pipe(_base_js_1.UnsignedInteger, v.description("Locked until timestamp (in ms since epoch).")),
...
function delegations(config, params, signal) {
    const request = (0, _base_js_1.parser)(exports.DelegationsRequest)({
        type: "delegations",
        ...params,
    });
