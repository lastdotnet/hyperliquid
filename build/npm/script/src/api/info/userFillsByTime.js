...
exports.UserFillsByTimeResponse = (() => {
    return v.pipe(v.array(_common_schemas_js_1.FillSchema), v.description("Array of user trade fills by time."));
})();
/**
 * Request array of user fills by time.
...
function userFillsByTime(config, params, signal) {
    const request = (0, _base_js_1.parser)(exports.UserFillsByTimeRequest)({
