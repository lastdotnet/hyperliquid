...
export declare class SubscriptionClient<T extends ISubscriptionTransport = ISubscriptionTransport> implements SubscriptionRequestConfig<T> {
     ...
     * ```
     */
    activeAssetCtx(...args: OmitFirst<OverloadedParameters<typeof activeAssetCtx>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    activeAssetData(...args: OmitFirst<OverloadedParameters<typeof activeAssetData>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    activeSpotAssetCtx(...args: OmitFirst<OverloadedParameters<typeof activeSpotAssetCtx>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    allMids(...args: OmitFirst<OverloadedParameters<typeof allMids>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    assetCtxs(...args: OmitFirst<OverloadedParameters<typeof assetCtxs>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    bbo(...args: OmitFirst<OverloadedParameters<typeof bbo>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    candle(...args: OmitFirst<OverloadedParameters<typeof candle>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    clearinghouseState(...args: OmitFirst<OverloadedParameters<typeof clearinghouseState>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    explorerBlock(...args: OmitFirst<OverloadedParameters<typeof explorerBlock>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    explorerTxs(...args: OmitFirst<OverloadedParameters<typeof explorerTxs>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    l2Book(...args: OmitFirst<OverloadedParameters<typeof l2Book>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    notification(...args: OmitFirst<OverloadedParameters<typeof notification>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    openOrders(...args: OmitFirst<OverloadedParameters<typeof openOrders>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    orderUpdates(...args: OmitFirst<OverloadedParameters<typeof orderUpdates>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    trades(...args: OmitFirst<OverloadedParameters<typeof trades>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userEvents(...args: OmitFirst<OverloadedParameters<typeof userEvents>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userFills(...args: OmitFirst<OverloadedParameters<typeof userFills>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userFundings(...args: OmitFirst<OverloadedParameters<typeof userFundings>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userHistoricalOrders(...args: OmitFirst<OverloadedParameters<typeof userHistoricalOrders>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userNonFundingLedgerUpdates(...args: OmitFirst<OverloadedParameters<typeof userNonFundingLedgerUpdates>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userTwapHistory(...args: OmitFirst<OverloadedParameters<typeof userTwapHistory>>): Promise<import("../../transport/base.js").Subscription>;
    /**
     ...
     * ```
     */
    userTwapSliceFills(...args: OmitFirst<OverloadedParameters<typeof userTwapSliceFills>>): Promise<import("../../transport/base.js").Subscription>;
    /**
