...
const activeAssetData_js_1 = require("../info/activeAssetData.js");
// -------------------- Schemas --------------------
...
exports.ActiveAssetDataEvent = (() => {
    return activeAssetData_js_1.ActiveAssetDataResponse;
})();
/**
...
function activeAssetData(config, params, listener) {
    const payload = (0, _base_js_1.parser)(exports.ActiveAssetDataRequest)({ type: "activeAssetData", ...params });
