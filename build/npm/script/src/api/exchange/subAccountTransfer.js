...
exports.SuccessResponse = exports.SubAccountTransferRequest = void 0;
 ...
 * ```
 */
async function subAccountTransfer(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.SubAccountTransferRequest.entries.action)({
