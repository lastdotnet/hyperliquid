...
exports.CWithdrawTypes = exports.SuccessResponse = exports.CWithdrawRequest = void 0;
 ...
 * ```
 */
async function cWithdraw(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.CWithdrawRequest.entries.action)({
        type: "cWithdraw",
    ...
    return await (0, _base_js_2.executeUserSignedAction)(config, { action, types: exports.CWithdrawTypes }, opts?.signal);
}
