...
exports.ApproveBuilderFeeTypes = exports.SuccessResponse = exports.ApproveBuilderFeeRequest = void 0;
...
exports.ApproveBuilderFeeRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            maxFeeRate: v.pipe(_base_js_1.Percent, v.description('Max fee rate (e.g., "0.01%").')),
            /** Builder address. */
 ...
 * ```
 */
async function approveBuilderFee(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.ApproveBuilderFeeRequest.entries.action)({
    ...
    return await (0, _base_js_2.executeUserSignedAction)(config, { action, types: exports.ApproveBuilderFeeTypes }, opts?.signal);
}
