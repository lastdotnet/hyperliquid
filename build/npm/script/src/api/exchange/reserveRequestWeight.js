...
exports.SuccessResponse = exports.ReserveRequestWeightRequest = void 0;
 ...
 * ```
 */
async function reserveRequestWeight(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.ReserveRequestWeightRequest.entries.action)({
