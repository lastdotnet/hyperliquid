...
exports.SuccessResponse = exports.VaultDistributeRequest = void 0;
 ...
 * ```
 */
async function vaultDistribute(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.VaultDistributeRequest.entries.action)({
