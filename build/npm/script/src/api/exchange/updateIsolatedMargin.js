...
exports.SuccessResponse = exports.UpdateIsolatedMarginRequest = void 0;
 ...
 * ```
 */
async function updateIsolatedMargin(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.UpdateIsolatedMarginRequest.entries.action)({
