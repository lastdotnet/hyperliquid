...
exports.SuccessResponse = exports.VaultModifyRequest = void 0;
 ...
 * ```
 */
async function vaultModify(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.VaultModifyRequest.entries.action)({
        type: "vaultModify",
        ...params,
    });
