...
exports.SuccessResponse = exports.EvmUserModifyRequest = void 0;
 ...
 * ```
 */
async function evmUserModify(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.EvmUserModifyRequest.entries.action)({
        type: "evmUserModify",
        ...params,
    });
