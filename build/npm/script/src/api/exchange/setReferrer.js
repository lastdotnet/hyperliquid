...
exports.SuccessResponse = exports.SetReferrerRequest = void 0;
 ...
 * ```
 */
async function setReferrer(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.SetReferrerRequest.entries.action)({
        type: "setReferrer",
        ...params,
    });
