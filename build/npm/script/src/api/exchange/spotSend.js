...
exports.SpotSendTypes = exports.SuccessResponse = exports.SpotSendRequest = void 0;
 ...
 * ```
 */
async function spotSend(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.SpotSendRequest.entries.action)({
        type: "spotSend",
    ...
    return await (0, _base_js_2.executeUserSignedAction)(config, { action, types: exports.SpotSendTypes }, opts?.signal);
}
