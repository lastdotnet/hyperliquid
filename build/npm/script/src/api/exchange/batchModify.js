...
exports.OrderSuccessResponse = exports.BatchModifyRequest = void 0;
 ...
 * ```
 */
async function batchModify(config, params, opts) {
    const action = (0, _base_js_1.parser)(exports.BatchModifyRequest.entries.action)({
        type: "batchModify",
        ...params,
    });
