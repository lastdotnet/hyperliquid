...
exports.SuccessResponse = exports.ClaimRewardsRequest = void 0;
 ...
 * ```
 */
async function claimRewards(config, opts) {
    const action = (0, _base_js_1.parser)(exports.ClaimRewardsRequest.entries.action)({
        type: "claimRewards",
    });
